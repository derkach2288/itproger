...
puts "Добрый день, #{name}! Ответьте на вопросы."            # аналог (puts "Добрый день, " + name)
...
results = [
  ...
  for item in questions do
      puts item                     # озвучиваем вопрос

      user_input = nil              # чтоб созранить ответ пользователя
  ...
  puts "\nВаш результат теста (ответов да - #{yes_anwers}):"
